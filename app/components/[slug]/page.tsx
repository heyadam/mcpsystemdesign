  ...
  return (
    <div className="p-6 md:p-10 max-w-4xl">
      ...
      <nav className="flex items-center gap-2 text-sm mb-6">
        <Link href="/components" className="text-gray-500 hover:text-gray-900 transition-colors">
          Components
        </Link>
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-semibold text-gray-900">{component.name}</h1>
        <p className="mt-3 text-gray-500 text-lg">{component.description}</p>
      ...
      <section id="overview" className="mt-8 scroll-mt-24">
        ...
        {component.overview ? (
          <div className="space-y-6">
            <p className="text-gray-600">{component.overview.introduction}</p>

            {component.overview.whenToUse && component.overview.whenToUse.length > 0 && (
              <div>
                <h3 className="text-sm font-semibold text-gray-900 mb-2">When to use</h3>
      ...
      <section id="specs" className="mt-12 scroll-mt-24">
        ...
        {/* Props Table */}
        <div className="mb-8">
          <h3 className="text-sm font-semibold text-gray-900 mb-4">Props</h3>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {component.specs.sizes.map((s) => (
                    <span key={s} className="px-2 py-1 text-xs bg-gray-100 text-gray-700 rounded">
                      {s}
                    </span>
                  ))}
                </div>
      ...
      <section id="guidelines" className="mt-12 scroll-mt-24">
        ...
        {component.guidelines ? (
          ...
          <p className="text-gray-500">No specific guidelines documented for this component yet.</p>
        )}
      </section>
      ...
      {relatedComponents.length > 0 && (
        <section className="mt-12 pt-8 border-t border-gray-200">
          <h2 className="text-sm font-semibold text-gray-900 mb-4">Related Components</h2>
          <div className="flex flex-wrap gap-2">
