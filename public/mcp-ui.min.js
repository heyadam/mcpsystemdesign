...
`)}_renderLineNumbers(){if(!this.showLineNumbers)return p;let e=this._getLines();return m`
    ...
    `}render(){let e=this.language||this.filename,r=this._getCodeContent();return m`
      <div class="container" part="container">
        ...
        <div class="code-wrapper">
          ...
          <pre part="code"><code>${r?ft(r):m`<slot @slotchange="${this._handleSlotChange}"></slot>`}</code></pre>
        </div>
      </div>
